                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('admin.administration.role.create') }}" class="btn btn-sm btn-light">Add
                                New Role</a>
                        </div>
                        @endcan
                        <!--end::Toolbar-->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-start ps-0">
                                            <span class="text-gray-600 fw-bold fs-6">{{ ($roles->currentPage() - 1) *
                                                $roles->perPage() + $loop->iteration }}</span>
                                        </td>
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="me-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                    ...
                                                    @can('audit-role')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.administration.role.audit',[$value->id]) }}"
                                                    ...
                                                    @can('edit-role')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.administration.role.edit',[$value->id]) }}"
                                                            class="menu-link px-3">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <form
                                                            action="{{ route('admin.administration.role.destroy',[$value->id]) }}"
