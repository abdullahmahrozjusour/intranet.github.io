...
@section('section')
<!--begin::Content-->
@include('components.header', ['name' => 'Subscribers'])
                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-800">Subscribers</span>
                        </h3>
                        <!--end::Title-->
                    </div>
                    <!--end::Header-->
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="me-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                    ...
                                                    <!--begin::Menu item-->
                                                    @can('audit-subscirber')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.administration.subscirber.audit',[$value->id]) }}"
                                                    ...
                                                    <!--begin::Menu item-->
                                                    @can('delete-subscirber')
                                                    <div class="menu-item px-3">
                                                        <form
                                                            action="{{ route('admin.administration.subscirber.destroy',[$value->id]) }}"
