                ...
                <div class="card-body pt-5">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                <label class="required form-label">Address (In English)</label>
                                <input type="text" name="addressEn" class="form-control form-control-lg form-control-solid rounded" placeholder="Address (In English)" value="{{ $data['addressEn'] ?? old('addressEn') }}">
                                @error('addressEn')
                        ...
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                <label class="form-label">Address (In Arabic) <span class="text-secondary">(Optional)</span></label>
                                <input type="text" name="addressAr" class="form-control form-control-lg form-control-solid rounded text-end" placeholder="Address (In Arabic)" value="{{ $data['addressAr'] ?? old('addressAr') }}">
                                @error('addressAr')
                                    <span class="text-danger">{{ $errors->first('addressAr') }}</span>
                                @enderror
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-12">
