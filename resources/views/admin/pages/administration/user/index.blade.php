...
@section('section')
<!--begin::Content-->
@include('components.header', ['name' => 'Users'])
                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('admin.administration.user.create') }}" class="btn btn-sm btn-light">Add
                                New User</a>
                        </div>
                        @endcan
                        <!--end::Toolbar-->
                            ...
                            <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                ...
                                <thead>
                                    <tr class="fs-7 fw-bold text-gray-500 border-bottom-0">
                                        ...
                                        <th class="p-0 pb-3 min-w-175px text-start">LAST NAME</th>
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="me-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                    ...
                                                    @can('audit-user')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.administration.user.audit',[$value->id]) }}"
                                                    ...
                                                    @can('edit-user')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.administration.user.edit',[$value->id]) }}"
                                                            class="menu-link px-3">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <form
                                                            action="{{ route('admin.administration.user.destroy',[$value->id]) }}"
