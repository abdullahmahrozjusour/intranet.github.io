                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <textarea id="descEn" name="descEn" cols="30" rows="10" class="form-control form-control-lg form-control-solid rounded" placeholder="Description (In English)">{{ $data['descEn'] ?? old('descEn') }}</textarea>
                                @error('descEn')
                        ...
                        <div class="col-md-6 col-12">
                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <textarea id="descAr" name="descAr" cols="30" rows="10" class="form-control form-control-lg form-control-solid rounded text-end" placeholder="Description (In Arabic)">{{ $data['descAr'] ?? old('descAr') }}</textarea>
                                @error('descAr')
