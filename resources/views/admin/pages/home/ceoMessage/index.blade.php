                    ...
                    <div class="card-header pt-7">
                        ...
                        <div class="card-toolbar">
                            <div class="btn-group">
                                ...
                                @endcan
                                @can('audit-ceo-message')
                                <a href="{{ route('admin.home.ceoMessage.audit',[$collection[0]->id]) }}"
    ...
    <div class="modal-dialog mw-1000px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y m-5">
                <!--begin::Form-->
                <form action="{{ route('admin.home.ceoMessage.update',[$collection[0]['id']]) }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="mb-10 fv-row fv-plugins-icon-container">
                                            ...
                                            <textarea name="descEn" id="descEn" cols="30" rows="10"
                                                class="form-control form-control-lg form-control-solid rounded"
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-10 fv-row fv-plugins-icon-container">
                                            <label class="form-label">Description (In Arabic) <span
                                                    class="text-secondary">(Optional)</span></label>
                                            <textarea name="descAr" id="descAr" cols="30" rows="10"
                                                class="form-control form-control-lg form-control-solid rounded text-end"
