                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('admin.home.event.create') }}" class="btn btn-sm btn-light">Add New Event</a>
                            </div>
                            @endcan
                            <!--end::Toolbar-->
                        </div>
                                                ...
                                                <td class="text-end pe-0">
                                                    <div class="me-0">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true" style="">
                                                            ...
                                                            @can('edit-event')
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('admin.home.event.edit',[$value->id]) }}" class="menu-link px-3">
                                                                    Edit
                                                                </a>
                                                            </div>
                                                            @endcan
                                                            ...
                                                            @can('delete-event')
                                                            <div class="menu-item px-3">
                                                                <form action="{{ route('admin.home.event.destroy',[$value->id]) }}" method="post" class="w-100">
                                                                    @method('DELETE')
                                                                    @csrf
