...
@section('section')
<!--begin::Content-->
@include('components.header', ['name' => 'Events'])
                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('admin.home.event.create') }}" class="btn btn-sm btn-light">Add New
                                Event</a>
                        </div>
                        @endcan
                        <!--end::Toolbar-->
                            ...
                            <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {{-- <td class="text-start ps-0">
                                            <span class="text-gray-600 fw-bold fs-6">{{
                                                \Carbon\Carbon::parse($value->time)->format('h:i A') }}</span>
                                        </td> --}}
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="me-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                    ...
                                                    @can('audit-event')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.home.event.audit',[$value->id]) }}"
                                                    ...
                                                    @can('edit-event')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.home.event.edit',[$value->id]) }}"
                                                            class="menu-link px-3">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <form
                                                            action="{{ route('admin.home.event.destroy',[$value->id]) }}"
