                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('admin.home.link.create') }}" class="btn btn-sm btn-light">Add New
                                Link</a>
                        </div>
                        @endcan
                        <!--end::Toolbar-->
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="me-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                    ...
                                                    @can('audit-link')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.home.link.audit',[$value->id]) }}"
                                                    ...
                                                    @can('edit-link')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.home.link.edit',[$value->id]) }}"
                                                            class="menu-link px-3">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <form
                                                            action="{{ route('admin.home.link.destroy',[$value->id]) }}"
