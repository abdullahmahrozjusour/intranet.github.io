            ...
            <div class="card-body pt-5">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" name="type"
                                class="form-control form-control-lg form-control-solid rounded" placeholder="Type"
                                value="{{ $data['type'] ?? old('type') }}">
                            @error('type')
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" name="titleEn"
                                ...
                                placeholder="Title (In English)" value="{{ $data['titleEn'] ?? old('titleEn') }}">
                            @error('titleEn')
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" name="titleAr"
                                ...
                                placeholder="Title (In Arabic)" value="{{ $data['titleAr'] ?? old('titleAr') }}">
                            @error('titleAr')
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            <label class="form-label">Description (In English) <span
                                    class="text-secondary">(Optional)</span></label>
                            <textarea id="descEn" name="descEn" cols="30" rows="10"
                                class="form-control form-control-lg form-control-solid rounded"
                                placeholder="Description (In English)">{{ $data['descEn'] ?? old('descEn') }}</textarea>
                            @error('descEn')
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            <label class="form-label">Description (In Arabic) <span
                                    class="text-secondary">(Optional)</span></label>
                            <textarea id="descAr" name="descAr" cols="30" rows="10"
                                class="form-control form-control-lg form-control-solid rounded text-end"
                                placeholder="Description (In Arabic)">{{ $data['descAr'] ?? old('descAr') }}</textarea>
                            @error('descAr')
