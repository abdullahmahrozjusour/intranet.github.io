...
@section('section')
    <!--begin::Content-->
    @include('components.header', ['name' => 'Modal Pages'])
                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-800">Modal Pages</span>
                            </h3>
                            <!--end::Title-->

                            <!--begin::Toolbar-->
                            {{-- <div class="card-toolbar">
                                <a href="{{ route('admin.home.modal.create') }}" class="btn btn-sm btn-light">Add New Modal Page</a>
                            </div> --}}
                            <!--end::Toolbar-->
                        </div>
                        <!--end::Header-->
                                                ...
                                                <td class="text-end pe-0">
                                                    <div class="me-0">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true" style="">
                                                            ...
                                                            @can('edit-modal-page')
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('admin.home.modal.edit',[$value->id]) }}" class="menu-link px-3">
                                                                    Edit
                                                                </a>
                                                            </div>
                                                            @endcan
                                                            ...
                                                            <!--begin::Menu item-->
                                                            {{-- <div class="menu-item px-3">
                                                                <form action="{{ route('admin.home.modal.destroy',[$value->id]) }}" method="post" class="w-100">
                                                                    @method('DELETE')
                                                                    @csrf
