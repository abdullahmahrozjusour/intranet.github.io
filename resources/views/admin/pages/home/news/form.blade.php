            ...
            <div class="card-body pt-5">
                <div class="row">
                    <div class="col-sm-4 col-12">
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            <label class="required form-label">News Title (In English)</label>
                            <input type="text" name="titleEn"
                                class="form-control form-control-lg form-control-solid rounded"
                                placeholder="News Title (In English)" value="{{ $data['titleEn'] ?? old('titleEn') }}">
                            @error('titleEn')
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            <label class="form-label">News Title (In Arabic) <span
                            ...
                            <input type="text" name="titleAr"
                                ...
                                placeholder="News Title (In Arabic)" value="{{ $data['titleAr'] ?? old('titleAr') }}">
                            @error('titleAr')
                ...
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            <label class="required form-label">News Date</label>
                            <input type="date" name="date"
                                class="form-control form-control-lg form-control-solid rounded" placeholder="News Date"
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" name="link"
                                class="form-control form-control-lg form-control-solid rounded" placeholder="Link"
                ...
                <div class="row">
                    <div class="col-sm-6 col-12">
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            <label class="required form-label">News Image</label>
                            <input type="file" name="image"
                                class="form-control form-control-lg form-control-solid rounded" placeholder="News Image"
