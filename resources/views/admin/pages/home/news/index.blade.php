                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-800">News</span>
                        </h3>
                        <!--end::Title-->
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('admin.home.news.create') }}" class="btn btn-sm btn-light">Add New
                                News</a>
                        </div>
                        @endcan
                        <!--end::Toolbar-->
                                    ...
                                    <tr>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="{{ $value->link }}" target="_blank"
                                                        ...
                                                        @if(file_exists(public_path('storage/uploads/news/'.$value->image)))
                                                        <img style="width:80px;height:40px;" class="bg-primary"
                                                            src="{{ asset('storage/uploads/news/'.$value->image) }}"
                                                            alt="{{ $value->image }}">
                                                        @endif
                                                        <span class="ms-3">{{ $value->titleEn }}</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-start ps-0">
                                            <span class="text-gray-600 fw-bold fs-6">{{
                                                \Carbon\Carbon::parse($value->date)->format('M,d Y') }}</span>
                                        </td>
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="me-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                    ...
                                                    @can('audit-news')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.home.news.audit',[$value->id]) }}"
                                                    ...
                                                    @can('edit-news')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.home.news.edit',[$value->id]) }}"
                                                            class="menu-link px-3">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <form
                                                            action="{{ route('admin.home.news.destroy',[$value->id]) }}"
