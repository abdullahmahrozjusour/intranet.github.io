        ...
        <div class="modal-dialog mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y m-5">
                    <!--begin::Form-->
                    <form action="{{ route('admin.operation.missionVision.updateData',[$collection[0]['id']]) }}" method="post" class="mx-auto w-100 py-10 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_create_account_form">
                        @csrf
                        @method('PUT')
                        <!--begin::Step 1-->
