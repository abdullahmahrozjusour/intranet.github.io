                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                    ...
                                    <thead>
                                        <tr class="fs-7 fw-bold text-gray-500 border-bottom-0">
                                            ...
                                            <th class="p-0 pb-3 min-w-175px text-start">SUBJECT</th>
                                        ...
                                        @foreach ($data as $key => $value)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-start ps-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{{ $value->country }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-start ps-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{{ $value->subject }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-end pe-0">
                                                    <div class="me-0">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true" style="">
                                                            ...
                                                            @can('delete-contact')
                                                            <div class="menu-item px-3">
                                                                <form action="{{ route('admin.pages.contact.destroy',[$value->id]) }}" method="post" class="w-100">
                                                                    @method('DELETE')
                                                                    @csrf
