                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <div class="card-toolbar">
                            <div class="btn-group">
                                @can('edit-main-board-of-director')
                                <button type="button" data-bs-toggle="modal" data-bs-target="#kt_modal_edit"
                                    class="btn btn-sm btn-light my-3">Edit</button>
                                @endcan
                                @can('audit-main-board-of-director')
                                <a href="{{ route('admin.pages.director.main.audit',[$collection[0]->id]) }}"
                                    class="btn btn-sm btn-light my-3">
                                    Audit
                                </a>
                                @endcan
                            </div>
                    ...
                    <div class="card-body pt-6">
                        ...
                        <div class="mb-10">
                            ...
                            <div class="text-center mb-15">
                                <!--begin::Title-->
                                <h3 class="fs-2hx text-gray-900 mb-5">{!! html_entity_decode($collection[0]->titleEn)
                                    !!}</h3>
                                <!--end::Title-->

                                <!--begin::Title-->
                                <h5 class="text-gray-900 mb-5">{!! html_entity_decode($collection[0]->shortDescEn) !!}
                                </h5>
                                <!--end::Title-->
                        ...
                        <div class="text-end mb-10">
                            <a href="{{ route('admin.pages.director.create') }}" class="btn btn-sm btn-light my-3">Add
                                New Board of Director</a>
                        </div>
                        @endcan
                        <!--end::Toolbar-->
                                        ...
                                        <td class="text-start ps-0">
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                                        class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 d-flex align-items-center">
                                                        @if(file_exists(public_path('assets/imgs/'.$value->logo)))
                                                        <img style="width:50px;height:50px;"
                                                            class="rounded-circle bg-primary"
                                                            src="{{ asset('assets/imgs/'.$value->logo) }}"
                                                            alt="{{ $value->logo }}">
                                                        @elseif(file_exists(public_path('storage/uploads/pages/'.$value->logo)))
                                                        <img style="width:50px;height:50px;"
                                                            class="rounded-circle bg-primary"
                                                            src="{{ asset('storage/uploads/pages/'.$value->logo) }}"
                                                            alt="{{ $value->logo }}">
                                                        @else
                                                        <img style="width:50px;height:50px;"
                                                            class="rounded-circle bg-primary"
                                                            src="{{ asset('assets/imgs/avatar.png') }}"
                                                            alt="avatar.png">
                                                        @endif
                                                    </a>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                                        ...
                                                        html_entity_decode($value->nameEn) !!}</a>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-start ps-0">
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                                        class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{!!
                                                        html_entity_decode($value->titleEn) !!}</a>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-start ps-0">
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                                        class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{!!
                                                        html_entity_decode($value->designationEn) !!}</a>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="me-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                    ...
                                                    <!--begin::Menu item-->
                                                    @can('audit-board-of-director')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.pages.director.audit',[$value->id]) }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.pages.director.edit',[$value->id]) }}"
                                                            class="menu-link px-3">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <form
                                                            action="{{ route('admin.pages.director.destroy',[$value->id]) }}"
...
<!--end::Content-->
<div class="modal fade" id="kt_modal_edit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog mw-1000px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y m-5">
                <!--begin::Form-->
                <form action="{{ route('admin.pages.director.updateData',[$collection[0]['id']]) }}" method="post"
                    class="mx-auto w-100 py-10 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate"
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="mb-10 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" name="titleEn" id="titleEn"
                                                ...
                                                value="{{ $collection[0]['titleEn'] ?? old('titleEn') }}">
                                            @error('titleEn')
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="mb-10 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" name="titleAr" id="titleAr"
                                                ...
                                                value="{{ $collection[0]['titleAr'] ?? old('titleAr') }}">
                                            @error('titleAr')
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-12">
                                        <div class="mb-10 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" name="shortDescEn"
                                                class="form-control form-control-lg form-control-solid rounded"
                                                placeholder="Short Description(In English)"
                                                value="{{ $collection[0]['shortDescEn'] ?? old('shortDescEn') }}">
                                            @error('shortDescEn')
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="mb-10 fv-row fv-plugins-icon-container">
                                            <label class="form-label">Short Description(In Arabic) <span
                                                    class="text-secondary">(Optional)</span></label>
                                            <input type="text" name="shortDescAr"
                                                class="form-control form-control-lg form-control-solid rounded text-end"
                                                placeholder="Short Description(In Arabic)"
                                                value="{{ $collection[0]['shortDescAr'] ?? old('shortDescAr') }}">
                                            @error('shortDescAr')
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="mb-10 fv-row fv-plugins-icon-container">
                                            ...
                                            <textarea name="descEn" cols="30" rows="10"
                                                class="form-control form-control-lg form-control-solid rounded"
                                                placeholder="Description (In English)">{{ $collection[0]['descEn'] ?? old('descEn') }}</textarea>
                                            @error('descEn')
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-10 fv-row fv-plugins-icon-container">
                                            <label class="form-label">Description (In Arabic) <span
                                                    class="text-secondary">(Optional)</span></label>
                                            <textarea name="descAr" cols="30" rows="10"
                                                class="form-control form-control-lg form-control-solid rounded text-end"
                                                placeholder="Description (In Arabic)">{{ $collection[0]['descAr'] ?? old('descAr') }}</textarea>
                                            @error('descAr')
