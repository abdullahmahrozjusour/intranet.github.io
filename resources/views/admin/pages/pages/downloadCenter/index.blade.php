                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('admin.pages.downloadCenter.create') }}" class="btn btn-sm btn-light">Add
                                New Download Center</a>
                        </div>
                        @endcan
                        <!--end::Toolbar-->
                    </div>
                                        ...
                                        <td class="text-start ps-0">
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex justify-content-start flex-column">
                                                    ...
                                                    <a href="{{ $value->url }}" title="{{ $value->nameEn }}"
                                                        class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6"
                                                        target="_blank">
                                                        <img width="50px" height="50px"
                                                            src="{{ asset('assets/images/'.$value->extension.'.png') }}"
                                                            alt="{{ $value->extension }}">
                                                    </a>
                                                    @else
                                                    <a href="{{ $value->url }}" title="{{ $value->nameEn }}"
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="me-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                    ...
                                                    <!--begin::Menu item-->
                                                    @can('audit-download-center')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.pages.downloadCenter.audit',[$value->id]) }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.pages.downloadCenter.edit',[$value->id]) }}"
                                                            class="menu-link px-3">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <form
                                                            action="{{ route('admin.pages.downloadCenter.destroy',[$value->id]) }}"
