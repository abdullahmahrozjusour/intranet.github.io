                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-body pt-6">
                            ...
                            {{-- <div class="text-end mb-10">
                                <a href="{{ route('admin.pages.missionVision.create') }}" class="btn btn-sm btn-light my-3">Add New Mission & Vision</a>
                            </div> --}}
                                                ...
                                                <td class="text-end pe-0">
                                                    <div class="me-0">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true" style="">
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('admin.pages.missionVision.edit',[$value->id]) }}" class="menu-link px-3">
                                                                    Edit
                                                                </a>
                                                            </div>
                                                            @endcan
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <form action="{{ route('admin.pages.missionVision.destroy',[$value->id]) }}" method="post" class="w-100">
                                                                    @method('DELETE')
                                                                    @csrf
        ...
        <div class="modal-dialog mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y m-5">
                    <!--begin::Form-->
                    <form action="{{ route('admin.pages.missionVision.updateData',[$collection[0]['id']]) }}" method="post" class="mx-auto w-100 py-10 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_create_account_form">
                        @csrf
                        @method('PUT')
                        <!--begin::Step 1-->
