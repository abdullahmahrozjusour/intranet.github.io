...
@section('section')
<!--begin::Content-->
@include('components.header', ['name' => 'Mission & Visions'])
                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-800">Mission & Visions</span>
                        </h3>
                        <!--end::Title-->
                        ...
                        <div class="card-toolbar">
                            <div class="btn-group">
                                @can('edit-main-mission-and-vision')
                                <button type="button" data-bs-toggle="modal" data-bs-target="#kt_modal_edit"
                                    class="btn btn-sm btn-light my-3">Edit</button>
                                @endcan
                                @can('audit-main-mission-and-vision')
                                <a href="{{ route('admin.pages.missionVision.main.audit',[$collection[0]->id]) }}"
                    ...
                    <div class="card-body pt-6">
                        ...
                        {{-- <div class="text-end mb-10">
                            <a href="{{ route('admin.pages.missionVision.create') }}"
                                class="btn btn-sm btn-light my-3">Add New Mission & Vision</a>
                        </div> --}}
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="me-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                    ...
                                                    <!--begin::Menu item-->
                                                    @can('audit-mission-and-vision')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.pages.missionVision.audit',[$value->id]) }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.pages.missionVision.edit',[$value->id]) }}"
                                                            class="menu-link px-3">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <form
                                                            action="{{ route('admin.pages.missionVision.destroy',[$value->id]) }}"
    ...
    <div class="modal-dialog mw-1000px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y m-5">
                <!--begin::Form-->
                <form action="{{ route('admin.pages.missionVision.updateData',[$collection[0]['id']]) }}" method="post"
