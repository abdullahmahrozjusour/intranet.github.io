                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('admin.pages.organization.create') }}" class="btn btn-sm btn-light">Add
                                New Organization</a>
                        </div>
                        @endcan
                        <!--end::Toolbar-->
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                                        ...
                                                        <img style="width:50px;height:50px;"
                                                            ...
                                                            src="{{ asset('storage/uploads/picture/'.$value->image) }}"
                                                            alt="{{ $value->image }}">
                                                        @elseif($value->id == 1)
                                                        <img style="width:50px;height:50px;"
                                                            class="rounded-circle bg-primary"
                                                            src="{{ asset('assets/imgs/ceo.png') }}"
                                                            alt="{{ $value->image }}">
                                                        @else
                                                        <img style="width:50px;height:50px;"
                                                            class="rounded-circle bg-primary"
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="me-0">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                    ...
                                                    <!--begin::Menu item-->
                                                    @can('audit-organization')
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.pages.organization.audit',[$value->id]) }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.pages.organization.edit',[$value->id]) }}"
                                                            class="menu-link px-3">
                                                            Edit
                                                        </a>
                                                    </div>
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <form
                                                            action="{{ route('admin.pages.organization.destroy',[$value->id]) }}"
