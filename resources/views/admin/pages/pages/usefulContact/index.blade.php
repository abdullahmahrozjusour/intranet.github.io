                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('admin.pages.usefulContact.create') }}" class="btn btn-sm btn-light">Add New Useful Contact</a>
                            </div>
                            @endcan
                            <!--end::Toolbar-->
                        </div>
                                        ...
                                        @foreach ($data as $key => $value)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-start ps-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{{ $value->addressEn }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-start ps-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{{ $value->email }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-start ps-0">
                                                    <div class="d-flex align-items-center">
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{{ $value->phone }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-end pe-0">
                                                    <div class="me-0">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true" style="">
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('admin.pages.usefulContact.edit',[$value->id]) }}" class="menu-link px-3">
                                                                    Edit
                                                                </a>
                                                            </div>
                                                            @endcan
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <form action="{{ route('admin.pages.usefulContact.destroy',[$value->id]) }}" method="post" class="w-100">
                                                                    @method('DELETE')
                                                                    @csrf
