                ...
                <div class="row">
                    <div class="bg-white px-6 py-4 shadow-lg  rounded-lg  mx-auto">
                                ...
                                <div class="grid grid-cols-2 gap-4 text-left mt-4 ">
                                    <div>
                                        <div class=" col-span-2 mt-2 flex form-group">
                                            ...
                                            <input type="date" class="in-input w-full" value="{{ $data['requestDate'] ?? old('requestDate') }}" id="requestDate" name="requestDate">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-2">
                                        <label for="requestId" class="flex justify-between"><span>No. Requests</span>
                                            <span>رقم
                                                الطلب</span></label>
                                        <input type="text" class="in-input" value="{{ $data['requestId'] ?? old('requestId') }}" id="requestId" name="requestId" readonly="">
                                    </div>
                                        ...
                                        <div class="grid grid-cols-1 gap-4 mt-1">
                                            <div class="flex items-center justify-between w-[150px] mx-auto">
                                                ...
                                                <div class="in-checkbox">
                                                    <input type="checkbox" name="urgencyType" value="urgent" id="urgent" data-id="justification" class="subscribe"
                                            ...
                                            <div class="flex items-center justify-between w-[150px] mx-auto">
                                                ...
                                                <div class="in-checkbox">
                                                    <input type="checkbox" name="urgencyType" value="normal" id="normal" data-id="justification" class="subscribe"
                            ...
                            <div class="grid grid-cols-1 gap-4 my-4">
                                ...
                                <div class="flex gap-4 w-full items-center">
                                    <label for="applicantContactNumber" class="whitespace-nowrap">Applicant contact no.</label>
                                    <input type="text" class="in-input w-full" id="applicantContactNumber" name="applicantContactNumber"
                            ...
                            <div id="manager-fields" class="grid grid-cols-2 gap-4 text-left mt-4 {{ !empty($data['managerName']) || !empty($data['managerEmail']) ? '' : 'hidden' }}">
                                <div>
                                    <div class="col-span-2 mt-2 flex form-group">
                            ...
                            <div class="grid grid-cols-1 gap-4 mt-2">
                                ...
                                <div class="grid grid-cols-3 justify-between items-center">
                                    ...
                                    <div class="mx-auto">
                                        <input type="checkbox" name="modificationRequestOfPreviousDesign" value="yes" class="w-5 h-5"
                                            id="mod"
                                ...
                                <div class="grid grid-cols-3 justify-between mt-2">
                                    ...
                                    <label for="deliveryDate" class="whitespace-nowrap text-right"> تاريـخ الاحتيـاج </label>
                                </div>
                            ...
                            <div id="justification" style="display: none">
                                <div class="bg-primary mt-4 px-4 py-2 font-medium text-md rounded-md text-white flex items-center justify-between gap-2">
                            ...
                            <div class="grid grid-cols-4 gap-4 mt-2">
                                ...
                                <div class="form-group col-span-4">
                                    ...
                                    <small class="text-[#8d1942] text-center">
                                        ...
                                        <br>
                                        في حـال طلـب تصميـم هويـة بصريـة جديـدة يجب تحديـد اجتماع مـع الإدارة لمناقشـة الطلـب وتحديـد المتطلبات.
                                    </small>
                                </div>
                                ...
                                <div dir="rtl"
                                    ...
                                    <div class="col-span-2">
                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="flyer[type]" value="1" id="flyer" {{ $flyerType == '1' ? 'checked' : '' }}>
                                ...
                                <div dir="rtl"
                                    ...
                                    <div class="col-span-2">
                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="rollUp[type]" value="1" id="rollUp" {{ $rollUpType == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="rollUp[size][]" value="w100H200" id="w100H200" {{ in_array('w100H200', $selectedRollUpSizes) ? 'checked' : '' }}>
                                        ...
                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="rollUp[size][]" value="w85H200" id="w85H200" {{ in_array('w85H200', $selectedRollUpSizes) ? 'checked' : '' }}>
                                ...
                                <div dir="rtl"
                                    ...
                                    <div class="col-span-2">
                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="brochure[type]" value="1" id="brochure" {{ $brochureType == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="brochure[size][]" value="Vertical" id="verticalBrochure" {{ in_array('Vertical', $selectedBrochureSizes) ? 'checked' : '' }}>
                                            <label for="verticalBrochure" class="block">Vertical طولي</label>
                                        </div>

                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="brochure[size][]" value="Horizontal" id="horizontalBrochure" {{ in_array('Horizontal', $selectedBrochureSizes) ? 'checked' : '' }}>
                                            <label for="horizontalBrochure" class="block">Horizontal عرضي</label>
                                        </div>

                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="brochure[size][]" value="Number of pages" id="noOfPageBrochure" {{ in_array('Number of pages', $selectedBrochureSizes) ? 'checked' : '' }}>
                                        ...
                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="brochure[size][]" value="Size" id="sizeBrochure" {{ in_array('Size', $selectedBrochureSizes) ? 'checked' : '' }}>
                                ...
                                <div dir="rtl"
                                    ...
                                    <div class="col-span-2">
                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="banner[type]" value="1" id="banner" {{ $bannerType == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="banner[size][]" value="Printed" id="printed" {{ in_array('Printed', $selectedBannerSizes) ? 'checked' : '' }}>
                                            <label for="printed" class="block">Printed مطبوعة</label>
                                        </div>

                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="banner[size][]" value="Digital" id="digital" {{ in_array('Digital', $selectedBannerSizes) ? 'checked' : '' }}>
                                            <label for="digital" class="block">Digital إليكترونية</label>
                                        </div>

                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="banner[size][]" value="Height" id="height" {{ in_array('Height', $selectedBannerSizes) ? 'checked' : '' }}>
                                            <label for="height" class="block">Height الارتفاع</label>
                                        </div>

                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="banner[size][]" value="Width" id="width" {{ in_array('Width', $selectedBannerSizes) ? 'checked' : '' }}>
                                ...
                                @php
                                    ...
                                    $businessCardTypeChecked = !empty($fbod['businessCardType']) && $fbod['businessCardType'] == '1';
                                    $otherDesignTypeChecked = !empty($fbod['otherDesignType']) && $fbod['otherDesignType'] == '1';
                                ...
                                <div dir="rtl"
                                    ...
                                    <div class="col-span-2">
                                        <div class="d-flex justify-content-between">
                                            <div class="in-checkbox ch-ar">
                                                <input type="checkbox" name="folderbusinessCardotherDesign[folderType]" value="1" id="folder"
                                                    {{ $folderTypeChecked ? 'checked' : '' }}>
                                                <label for="folder" class="flex">Folder <br> ملف</label>
                                            </div>
                                            <div class="in-checkbox ch-ar">
                                                <input type="checkbox" name="folderbusinessCardotherDesign[businessCardType]" value="1" id="businessCard"
                                                    {{ $businessCardTypeChecked ? 'checked' : '' }}>
                                                <label for="businessCard" class="flex">business card <br> بطاقة عمل</label>
                                            </div>
                                            <div class="in-checkbox ch-ar">
                                                <input type="checkbox" name="folderbusinessCardotherDesign[otherDesignType]" value="1" id="otherDesign"
                                                    {{ $otherDesignTypeChecked ? 'checked' : '' }}>
                                                <label for="otherDesign" class="flex">Other Designs <br> تصاميم أخرى</label>
                                            </div>
                                        </div>
                                        <div class="form-group col-span-4">
                                    ...
                                    <div class="col-span-2">
                                        <div class="in-checkbox ch-ar">
                                            <input type="checkbox" name="uniformDesign[type]" value="1" id="uniformDesign"
                                                {{ $typeChecked ? 'checked' : '' }}>
                                            <label for="uniformDesign" class="flex">Uniform Design <br>تصميم الملابس</label>
                                        </div>
                                        <div class="form-group col-span-4">
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-2">
                                ...
                                <div class="flex justify-between col-span-2">
                                    <div class="in-checkbox col-span-2">
                                        <input type="checkbox" class="in-input" id="termsAndConditions" name="termsAndConditions" value="1"
                                            {{ $termsChecked ? 'checked' : '' }}>
                                        <label for="termsAndConditions">All terms have been read below تم</label>
                                    </div>
                                    <div class="in-checkbox ch-ar col-span-2" dir="rtl">
                                        <input type="checkbox" class="in-input" id="termsAndConditionsAr" name="termsAndConditions" value="1"
                                            {{ $termsChecked ? 'checked' : '' }}>
