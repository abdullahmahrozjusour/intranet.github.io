    ...
    <div class="fixed left-0 right-0 top-0 bottom-0 h-full w-full bg-black/50 overflow-x-hidden overflow-y-auto hidden"
        ...
        <div class="max-w-[700px] w-full mx-auto rounded-lg overflow-hidden relative ">
            <div class="bg-secondary relative text-center font-semibold text-2xl flex justify-center p-2 text-white">
                Policies <a class="text-white absolute right-4 close-in" href="#policyModal"><i
                        class="fa-solid fa-xmark"></i></a></div>
            <div class="bg-modal">
                <div class="px-8 py-4 content-modal">
                    <h3>Policies</h3>

                    <p>At Jusour, our policies are designed to ensure a safe, respectful, and productive environment for
    ...
    <div class="fixed left-0 right-0 top-0 bottom-0 h-full w-full bg-black/50 overflow-x-hidden overflow-y-auto hidden"
        ...
        <div class="max-w-[700px] w-full mx-auto rounded-lg overflow-hidden relative ">
            <div class="bg-secondary relative text-center font-semibold text-2xl flex justify-center p-2 text-white">
                Procedure <a class="text-white absolute right-4 close-in" href="#Procedure"><i
                        class="fa-solid fa-xmark"></i></a></div>
            <div class="bg-modal">
                <div class="px-8 py-4 content-modal">
                    <h3>Procedures</h3>
                    <p>At Jusour, our procedures provide clear guidelines for carrying out essential processes and tasks
