        ...
        <div class="container">
            <div class="flex gap-6 justify-center">
                ...
                <div class="max-w-[1000px]">
                    <a href="{{ route('form-pdf') }}" class="btn-blue max-w-20 flex justify-center mb-4 ml-auto"
                        ...
                        <div class="bg-white px-6 py-4 shadow-lg  rounded-lg  mx-auto">
                                ...
                                <div class="grid grid-cols-2 gap-4 text-left mt-4 ">
                                    <div>
                                        <div class=" col-span-2 mt-2 flex form-group">
                                            ...
                                            <input type="date" class="in-input w-full" value="2025-05-26"
                            ...
                            <div class="grid grid-cols-1 gap-4 my-4">
                                <div class=" flex gap-4 w-full items-center">
                                    ...
                                    <label for="applicantName" class="font-shubuk">الاسم </label>
                                </div>
                                <div class="flex gap-4 w-full items-center">
                                    ...
                                    <label for="applicantContactNumber" class="font-shubuk">الهاتف</label>
                                </div>
                                <div class="flex gap-4 w-full items-center">
                                    <label for="applicantEmail" class="whitespace-nowrap">Applicant e-mail </label>
                                    <input type="email" class="in-input w-full" id="applicantEmail"
                                        name="applicantEmail" placeholder="Applicant e-mail / الإيميل">
                                    <label for="" class="font-shubuk">الإيميل</label>
                                </div>
                                <div class="flex gap-4 w-full items-center">
                                    <label for="department">Department </label>
                                    <input type="text" class="in-input w-full" id="department" name="department"
                                        placeholder="Department / القسم">
                                    <label for="department" class="font-shubuk">القسم</label>
                                </div>
                            </div>
                                ...
                                <div>
                                    <div class="col-span-2 mt-2 flex form-group">
                                        ...
                                        <input type="text" class="in-input w-full" id="managerName"
                                            name="managerName" placeholder="Your Manager Name / اسم مديرك">
                                    </div>
                                </div>
                            ...
                            <div id="justification" style="display: none">
                                <div
                                    class="bg-primary mt-4 px-4 py-2 font-medium text-md rounded-md text-white flex items-center justify-between gap-2">
                                    <span>Justification for the Urgent Request </span> <span class="font-shubuk">العاجل
                                        الطلب مبررات</span>
                                </div>
                                <div class="grid grid-cols-1 gap-4 mt-2">
                            ...
                            <div
                                class="bg-primary mt-4 px-4 py-2 font-medium text-md rounded-md text-white flex items-center justify-between gap-2">
                                <span>Purpose of the Request </span> <span class="font-shubuk">الطلب من الغرض</span>
                            </div>
                            <div class="grid grid-cols-1 gap-4 mt-2">
                                <div class="form-group">
                            ...
                            <div class="grid grid-cols-4 gap-4 mt-2">
                                <div class="in-checkbox">
                                    ...
                                    <label for="vh" class="flex">Vehicle branding <br> <span
                                            class="font-shubuk">تصميم المركبات</span> </label>
                                </div>
                                <div class="in-checkbox">
                                    <input type="checkbox" name="requestType[]" value="Signage Design" id="signage">
                                    <label for="signage" class="flex">Signage design <br> <span
                                            class="font-shubuk">لوحات إرشادية</span> </label>
                                </div>
                                <div class="in-checkbox">
                                    <input type="checkbox" name="requestType[]" value="Trophy / Gift Design"
                                        id="trophy">
                                    <label for="trophy" class="flex">Trophy / Gift design <br> <span
                                            class="font-shubuk">تصميم درع / هدية</span>
                                    </label>
                                </div>
                                <div class="in-checkbox">
                                    <input type="checkbox" name="requestType[]" value="Full New Corporate Identity"
                                        id="identity">
                                    <label for="identity" class="flex">Full new corporate identity <br> <span
                                            class="font-shubuk">هوية بصرية جديدة</span>
                                    </label>
                                </div>
                                <div class="in-checkbox">
                                    <input type="checkbox" name="requestType[]" value="Other Designs" id="other">
                                    <label for="other" class="flex">Other designs <br> <span
                                            class="font-shubuk">تصاميم أخرى</span> </label>
                                </div>
                                <div class="in-checkbox">
                                    <input type="checkbox" name="requestType[]" value="Certificate" id="certificate">
                                    <label for="certificate" class="flex">Certificate <br> <span
                                            class="font-shubuk">تصميم الشهادات</span> </label>
                                </div>
                                <div class="in-checkbox">
                                    <input type="checkbox" name="requestType[]" value="Presentation" id="presentation">
                                    <label for="presentation" class="flex">Presentation <br> <span
                                            class="font-shubuk">تصميم عروض تقديمية</span> </label>
                                </div>
                                <div class="in-checkbox">
                                    <input type="checkbox" name="requestType[]" value="Letterhead" id="letterhead">
                                    <label for="letterhead" class="flex">Letterhead <br> <span
                                            class="font-shubuk">تصميم أوراق المراسلات</span> </label>
                                </div>
                                ...
                                <div dir="rtl"
                                    ...
                                    <div class="col-span-2">
                                        <div class="in-checkbox ch-ar">
                                            ...
                                            <label for="popup" class="flex">Pop-up <br> <span
                                                    class="font-shubuk">خلفية (بوب-آب)</span> </label>
                                        </div>
                                        <div class="form-group col-span-4">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <div>Specifications <br> <span class="المواصفات"></span></div>
                                        <div class="in-checkbox ch-ar">
                                ...
                                <div dir="rtl"
                                    ...
                                    <div class="col-span-2">
                                        <div class="in-checkbox ch-ar">
                                            ...
                                            <label for="notebook" class="flex">Notebook <br> <span
                                                    class="font-shubuk">تصميم دفاتر الملاحظات</span>
                                            </label>
                                        </div>
                                        <div class="form-group col-span-4">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <div>Specifications <br> <span class="font-shubuk">المواصفات</span></div>
                                        <div class="in-checkbox ch-ar">
                                ...
                                <div dir="rtl"
                                    ...
                                    <div class="col-span-2">
                                        <div class="in-checkbox ch-ar">
                                            ...
                                            <label for="flyer" class="flex">Flyer <br> <span
                                                    class="font-shubuk">تصميم ورقة إعلانية (فلاير)</span>
                                            </label>
                                        </div>
                                        <div class="form-group col-span-4">
                                ...
                                <div dir="rtl"
                                    ...
                                    <div class="col-span-2">
                                        <div class="in-checkbox ch-ar">
                                            ...
                                            <label for="rollUp" class="flex">Roll-up <br> <span
                                                    class="font-shubuk">رول - آب</span></label>
                                        </div>
                                        <div class="form-group col-span-4">
                                ...
                                <div dir="rtl"
                                    ...
                                    <div class="col-span-2">
                                        <div class="in-checkbox ch-ar">
                                            ...
                                            <label for="brochure" class="flex">Brochure <br> <span
                                ...
                                <div dir="rtl"
                                    ...
                                    <div class="col-span-2">
                                        <div class="in-checkbox ch-ar">
                                            ...
                                            <label for="banner" class="flex">Banner <br><span
                                                    class="font-shubuk">خلفية (بانر)</span> </label>
                                        </div>
                                        <div class="form-group col-span-4">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="in-checkbox ch-ar">
                                                <input type="checkbox" name="folderbusinessCardotherDesign[folderType]"
                                                    value="1" id="folder">
                                                <label for="folder" class="flex">Folder <br> <span
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-2">
                                <div class="flex justify-between col-span-2">
                                    ...
                                    <div class="in-checkbox ch-ar col-span-2" dir="rtl">
                                        ...
                                        <label for="termsAndConditions">
                                            <span class="font-shubuk">أدناه الشروط جميع قراءة
                                                تم</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="border border-secondary rounded-md p-4">
                                    <div class="mb-4">Signature - <span class="font-shubuk"></span></div>
                                ...
                                <div class=" border border-secondary rounded-md p-4">
                                    <div class="mb-4">Date - <span class="font-shubuk"></span></div>
                            ...
                            <div
                                class="bg-primary mt-4 px-4 py-2 font-medium text-md rounded-md justify-between text-white flex items-center gap-2">
                                <span>For design unit official use </span> <span class="font-shubuk">للاستعمال الرسمي من قبل وحدة
                                    التصميم</span>
                            </div>
                            <div class="grid grid-cols-1 gap-4 mt-2">
                                <div class="form-group">
