                ...
                <div class="bg-white px-6 py-4 shadow-lg  rounded-lg max-w-[1000px] mx-auto">
                    ...
                    <div class="grid grid-cols-1 gap-4 mt-2">
                        ...
                        <div class="flex flex-col">
                            <label for="">&nbsp;</label>
                            <small class="text-secondary text-center">هذا الطلب للتصميم فقط حيث لا يشمل وقت الطباعة أو
                                التصنيع أو أية
                                آلية
                                تطبيق أخرى
                            </small>
                            <small class="text-secondary text-center">This request is for design only and does not include
                                printing
                                time,
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-2">
                        ...
                        <div class="col-span-2 flex justify-between"><span>Department Manager</span> <span> مدير الإدارة
                            </span></div>
