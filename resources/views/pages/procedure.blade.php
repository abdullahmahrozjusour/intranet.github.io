...
@section('content')
    <div class="bg-bubble bg-primary">
        <div class="container-in text-white">
            <h3 class="font-bold text-3xl lg:text-4xl text-white mb-4 pt-14">Procedures</h3>

            <h4 class="mt-5 mb-1 text-xl font-semibold">Policies</h4>
            <p>At Jusour, our policies are designed to ensure a safe, respectful, and productive environment for all employees,
