                    ...
                    <div class="grid sm:grid-cols-2 gap-6">
                        @foreach ($data['useful'] as $item)
                            <div class="flex flex-col gap-1">
                                ...
                                <div class="flex items-center gap-2 text-white font-medium text-sm">
                                    <i class="fa-solid fa-phone"></i><span> <a href="tel:{{ $item['phone'] }}">{{ $item['phone'] }}</a></span>
                                </div>
                                <div class="flex items-center gap-2 text-white font-medium text-sm">
                                    <i class="fa-solid fa-envelope"></i><span><a href="mailto:{{ $item['email'] }}">{{ $item['email'] }}</a></span>
                                </div>
                            </div>
                        @endforeach
                    </div>
